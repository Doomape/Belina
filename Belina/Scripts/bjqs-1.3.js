...
;(function($) {
    ...
    $.fn.bjqs = function(o) {
        ...
        var conf_controls = function() {
            ...
            // bind click events
            $c_wrapper.bind('click','a',function(e){
                e.preventDefault();
                var direction = $(this).find('a').attr('data-direction');
        ...
        var conf_captions = function() {
            ...
            $.each($slides, function (key, slide) {
                ...
                var header = $(slide).children('meta').attr('content');
                ...
                if (caption) {
                    ...
                    header = $('<h1 class="bjqs-caption1">' + header + '</h1>');
                    header.appendTo($(slide));
                    //caption = $('<p>koki</p>'); caption.appendTo($(slide));
                }
